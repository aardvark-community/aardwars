...
module Scene = 
    ...
    let boxSg (cubes : (Trafo3d * Material)[]) = 
        ...
        let grasstexture =
            PixTexture2d(PixImageMipMap [| PixImage.Load(@"C:\Users\smaierhofer\Desktop\Aardwars\Textures\grasstexture.jpg") |], true) :> ITexture
            |> AVal.constant
        let lavatexture =
            PixTexture2d(PixImageMipMap [| PixImage.Load(@"C:\Users\smaierhofer\Desktop\Aardwars\Textures\lavatexture.jpg") |], true) :> ITexture
            |> AVal.constant
        let rockstexture =
            PixTexture2d(PixImageMipMap [| PixImage.Load(@"C:\Users\smaierhofer\Desktop\Aardwars\Textures\rockstexture.jpg") |], true) :> ITexture
            |> AVal.constant
        let brickstexture =
            PixTexture2d(PixImageMipMap [| PixImage.Load(@"C:\Users\smaierhofer\Desktop\Aardwars\Textures\brickstexture.jpg") |], true) :> ITexture
            |> AVal.constant
        let watertexture =
            PixTexture2d(PixImageMipMap [| PixImage.Load(@"C:\Users\smaierhofer\Desktop\Aardwars\Textures\watertexture.jpg") |], true) :> ITexture
            |> AVal.constant
        let steelwalltexture =
            PixTexture2d(PixImageMipMap [| PixImage.Load(@"C:\Users\smaierhofer\Desktop\Aardwars\Textures\steelwalltexture.jpg") |], true) :> ITexture
            |> AVal.constant
        let steelfloortexture =
            PixTexture2d(PixImageMipMap [| PixImage.Load(@"C:\Users\smaierhofer\Desktop\Aardwars\Textures\steelfloortexture.jpg") |], true) :> ITexture
            |> AVal.constant
